...
class DemoSamplerWrapper(Wrapper):
    ...
    def __init__(
        ...
        ), "Wrapped env {} does not match env on which multi_agent were collected ({})".format(
    ...
    def _reverse_sample_open_loop(self):
        ...
        # sample uniformly in a window that grows backwards from the end of the multi_agent
        states = self.demo_file["data/{}/states".format(ep_ind)][()]
    ...
    def _forward_sample_open_loop(self):
        ...
        # sample uniformly in a window that grows forwards from the beginning of the multi_agent
        states = self.demo_file["data/{}/states".format(ep_ind)][()]
        eps_len = states.shape[0]
